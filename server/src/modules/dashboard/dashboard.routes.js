...
import { getStats, getRecentActivity, getInventoryOverview, getEmployeeStats } from './dashboard.controller.js'
...
router.get('/employee-stats', requireRole('manager'), getEmployeeStats)
